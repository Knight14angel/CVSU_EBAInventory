        ...
        <div class="main-content">
            ...
            ?>
                    ...
                    if ($conn->connect_error) {
                        ...
                        $sql = "SELECT name, role, email, created_at FROM logs WHERE role = ? ORDER BY created_at DESC LIMIT 1";
                    ...
                    ?>
                            <div class="profile-details">
                                ...
                                <p><strong>Last Login:</strong> <?= htmlspecialchars($row['created_at']) ?></p>
                            </div>
                        <?php
                        } else {
                        ?>
