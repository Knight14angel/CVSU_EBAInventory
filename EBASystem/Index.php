...
<head>
    ...
    <style>
        ...
        body {
            ...
            /* Choosing 'Inter' for a clean, modern feel */
            margin: 0;
            /* No pesky default margins */
            padding: 0;
            /* No default padding either */
            display: flex;
            /* Using flexbox to easily center and structure the dashboard */
            min-height: 100vh;
            /* Make sure the dashboard takes up the full screen height */
            background: linear-gradient(135deg, #8A2BE2, #32CD32);
            /* A beautiful gradient from a rich violet to a vibrant green */
            color: #333;
            /* A soft, dark grey for most text, easy on the eyes */
            overflow-x: hidden;
            /* Preventing any annoying horizontal scrollbars */
        }

        /* --- The Main Dashboard Container --- */
        .dashboard-container {
            display: flex;
            /* Again, flexbox for flexible layout of sidebar and main content */
            width: 100%;
            /* Take up all available width */
            max-width: 1200px;
            /* But don't get too wide on huge screens, keep it focused */
            margin: 20px auto;
            /* Center the whole dashboard with a bit of breathing room around it */
            background-color: rgba(255, 255, 255, 0.95);
            /* A slightly transparent white for a clean, airy feel */
            border-radius: 15px;
            /* Nicely rounded corners for a modern, friendly look */
            box-shadow: 0 10px 25px rgba(0, 0, 0, 0.2);
            /* A subtle shadow to make it pop off the background */
            overflow: hidden;
            /* Crucial for ensuring the rounded corners apply perfectly to inner elements */
        }

        /* --- The Sidebar: Your Navigation Hub --- */
        .sidebar {
            width: 250px;
            /* A fixed width for the navigation panel */
            background-color: #6A0DAD;
            /* A deep, rich violet for a strong, reliable feel */
            color: white;
            /* White text for great contrast against the dark violet */
            padding: 20px;
            /* Some internal padding for content */
            box-shadow: 5px 0 15px rgba(0, 0, 0, 0.1);
            /* A subtle shadow on the right to visually separate it */
            display: flex;
            /* Flexbox for stacking navigation items */
            flex-direction: column;
            /* Stack items vertically */
            border-top-left-radius: 15px;
            /* Inherit the main container's rounded corners */
        ...
        .sidebar h2 {
            ...
            color: #E0BBE4;
            /* A softer, lighter violet for the heading, adding a touch of elegance */
            margin-bottom: 30px;
            /* Space below the title */
            font-size: 1.8em;
            /* A good size for the main title */
        }
        ...
        .sidebar nav ul li a {
            ...
            padding: 12px 15px;
            /* Generous padding for easy clicking/tapping */
            color: white;
            /* White text for navigation links */
            text-decoration: none;
            /* Remove the default underline */
            border-radius: 8px;
            /* Slightly rounded corners for each link, making them feel like buttons */
        ...
        .sidebar nav ul li a.active {
            ...
            /* A slightly lighter violet when hovered or active, giving visual feedback */
            transform: translateX(5px);
            /* A subtle slide effect on hover for a dynamic feel */
        }

        /* --- Main Content Area: Where the Action Happens --- */
        .main-content {
            flex-grow: 1;
            /* This makes the content area expand to fill all available space */
            padding: 30px;
            /* Ample padding around the content */
            background-color: #fff;
            /* Pure white background for content clarity */
            border-top-right-radius: 15px;
            /* Inherit the main container's rounded corners */
            border-bottom-right-radius: 15px;
            /* Inherit the main container's rounded corners */
            overflow-y: auto;
            /* Enable vertical scrolling if the content gets too long */
        }

        .main-content h1 {
            color: #8A2BE2;
            /* A vibrant violet for main section headings, matching the theme */
            margin-bottom: 25px;
            /* Space below the heading */
            font-size: 2.2em;
            /* A prominent size for main titles */
            border-bottom: 2px solid #32CD32;
            /* A striking green underline to highlight sections */
            padding-bottom: 10px;
            /* Space between the heading text and its underline */
        }

        /* --- Form Styling: Making Input User-Friendly --- */
        .form-group {
            margin-bottom: 15px;
            /* Space between form input groups */
        }
        ...
        .form-group label {
            ...
            margin-bottom: 5px;
            /* Small space between label and input field */
            font-weight: bold;
            /* Bold labels for clarity */
            color: #555;
            /* A slightly darker grey for labels */
        }
        ...
        .form-group select {
            width: calc(100% - 20px);
            /* Make inputs fill almost the full width, accounting for padding */
            padding: 10px;
            /* Good padding inside input fields for readability */
            border: 1px solid #ddd;
            /* A subtle light grey border */
            border-radius: 8px;
            /* Softly rounded input fields */
            font-size: 1em;
            /* Standard font size */
        ...
        .btn {
            ...
            /* Our signature green for primary actions */
            color: white;
            /* White text on green for excellent contrast */
            padding: 10px 20px;
            /* Comfortable padding for buttons */
            border: none;
            /* No default border */
            border-radius: 8px;
            /* Rounded button corners for a friendly feel */
            cursor: pointer;
            ...
            /* A gentle shadow for depth */
        }

        .btn:hover {
            background-color: #28A745;
            /* A slightly darker green on hover for visual feedback */
        ...
        .btn-danger {
            ...
            /* A bold red for destructive actions like deleting */
        }
        ...
        .btn-warning {
            ...
            /* A warm yellow for caution, like archiving */
            color: #333;
            /* Dark text for contrast against the yellow */
        }
        ...
        .btn-info {
            /* New style for the restore button */
            background-color: #17a2b8;
            /* A nice blue for informational/restore actions */
            color: white;
        }
        ...
        /* --- Table Styling: Presenting Data Clearly --- */
        .data-table {
            width: 100%;
        ...
        .data-table td {
            padding: 12px 15px;
            /* Comfortable padding within table cells */
        ...
        .data-table th {
            ...
            /* A lighter violet for table headers, consistent with the theme */
            color: #6A0DAD;
            /* Dark violet text for header content */
            font-weight: bold;
            /* Bold headers for emphasis */
            text-transform: uppercase;
            /* Uppercase text for headers for a professional look */
            font-size: 0.9em;
        ...
        .data-table tr:nth-child(even) {
            ...
            /* Subtle light stripe for alternating rows, improving readability */
        }

        .data-table tr:hover {
            background-color: #f1f1f1;
            /* Gentle highlight on row hover */
        }

        .data-table td form {
            display: inline-block;
            /* Keep action buttons on the same line */
            margin-right: 5px;
            /* Small space between buttons */
        }

        /* --- Sales Section Specifics: Highlighting Key Info --- */
        .sales-summary {
            background-color: #f0f8ff;
            /* A very light blue background for summary blocks */
            border: 1px solid #d0e0f0;
            /* A slightly darker blue border */
            border-radius: 10px;
            /* Rounded corners for summary boxes */
            padding: 20px;
            /* Internal padding */
            margin-bottom: 20px;
            /* Space below each summary box */
        }

        .sales-summary h3 {
            color: #8A2BE2;
            /* Violet heading for sales summaries */
            margin-top: 0;
            /* No top margin */
        }
        ...
        .sales-summary p {
            font-size: 1.1em;
            /* Slightly larger text for key sales figures */
            color: #444;
            /* A soft dark grey for summary text */
        }
        ...
        @media (max-width: 768px) {
            .dashboard-container {
                flex-direction: column;
                /* On smaller screens, stack sidebar and content vertically */
                margin: 10px;
            ...
            .sidebar {
                ...
                /* Only top corners rounded when stacked */
                padding: 15px;
            ...
            .sidebar nav ul li {
                margin: 5px;
                /* Smaller margin between horizontal nav items */
            }
            ...
            .main-content {
                ...
                /* Only bottom corners rounded when stacked */
            }
        ...
        <div class="main-content">
            ...
            ?>
                    ...
                    <div class="profile-details">
                        <p><strong>Name:</strong> Our Valued User</p>
                        <p><strong>Role:</strong> Inventory Manager Extraordinaire</p>
                        <p><strong>Email:</strong> manager@yourcompany.com</p>
                        <p><strong>Last Activity:</strong> <?php echo date('Y-m-d H:i:s'); ?> (Just now!)</p>
                    </div>
                <?php
                    break;
